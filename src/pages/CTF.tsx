...
const SAMPLE_CHALLENGES: Challenge[] = [
  ...
  { id: 's2', title: 'XSS Reflected Attack', description: 'Explore uma vulnerabilidade XSS para roubar cookies do administrador. O alvo é o parâmetro de busca.', category: 'web', difficulty: 'easy', points: 100, flag: 'PAJI{xss_reflected}', hint: 'Parâmetro de busca é vulnerável a scripts', solution_explanation: null, order_index: 2, is_active: true, challenge_url: 'https://ctf-challenges.blynk.app/xss-reflected' },
  ...
  { id: 's5', title: 'SSRF Interno', description: 'Use SSRF para acessar serviços internos da rede e obter a flag do servidor de metadados.', category: 'web', difficulty: 'expert', points: 650, flag: 'PAJI{ssrf_interno}', hint: 'URL parameter redireciona para serviços internos', solution_explanation: null, order_index: 5, is_active: true, challenge_url: 'https://ctf-challenges.blynk.app/ssrf' },
  ...
  { id: 's7', title: 'Local File Inclusion', description: 'Leia arquivos do servidor usando LFI. O objetivo é ler /etc/passwd.', category: 'web', difficulty: 'easy', points: 100, flag: 'PAJI{lfi_attack}', hint: 'Parâmetro page é vulnerável', solution_explanation: null, order_index: 7, is_active: true, challenge_url: 'https://ctf-challenges.blynk.app/lfi' },
  { id: 's8', title: 'Command Injection', description: 'Execute comandos no servidor através de input não sanitizado no campo de ping.', category: 'web', difficulty: 'medium', points: 300, flag: 'PAJI{cmd_injection}', hint: 'Use ; ou | para concatenar comandos', solution_explanation: null, order_index: 8, is_active: true, challenge_url: 'https://ctf-challenges.blynk.app/cmd-injection' },
  { id: 's9', title: 'NoSQL Injection MongoDB', description: 'Bypass de autenticação usando NoSQL injection em MongoDB. O login usa JSON.', category: 'web', difficulty: 'medium', points: 350, flag: 'PAJI{nosql_injection}', hint: 'Use operadores MongoDB como $ne', solution_explanation: null, order_index: 9, is_active: true, challenge_url: 'https://ctf-challenges.blynk.app/nosql' },
  ...
  { id: 's11', title: 'IDOR Vulnerability', description: 'Acesse dados de outros usuários através de referência direta de objeto.', category: 'web', difficulty: 'easy', points: 150, flag: 'PAJI{idor_vuln}', hint: 'Mude o ID na URL de /user/1 para outros números', solution_explanation: null, order_index: 11, is_active: true, challenge_url: 'https://ctf-challenges.blynk.app/idor' },
  ...
  { id: 's14', title: 'DOM-based XSS', description: 'Explore XSS no lado do cliente através de manipulação do DOM via location.hash.', category: 'web', difficulty: 'medium', points: 320, flag: 'PAJI{dom_xss}', hint: 'JavaScript eval vulnerável no hash da URL', solution_explanation: null, order_index: 14, is_active: true, challenge_url: 'https://ctf-challenges.blynk.app/dom-xss' },
  ...
  { id: 's22', title: 'Padding Oracle Attack', description: 'Use padding oracle para decifrar AES-CBC byte por byte através de erros de padding.', category: 'crypto', difficulty: 'expert', points: 700, flag: 'PAJI{padding_oracle}', hint: 'Erro diferente para padding inválido', solution_explanation: null, order_index: 22, is_active: true, challenge_url: 'https://ctf-challenges.blynk.app/padding-oracle' },
  { id: 's23', title: 'XOR Cipher Break', description: 'Quebre a cifra XOR com chave repetida usando análise de frequência.', category: 'crypto', difficulty: 'easy', points: 100, flag: 'PAJI{xor_cipher}', hint: 'Chave de 4 bytes, texto é em inglês', solution_explanation: null, order_index: 23, is_active: true, file_url: 'https://files.ctf.blynk.app/xor_encrypted.bin' },
  { id: 's24', title: 'Substitution Cipher', description: 'Quebre a cifra de substituição monoalfabética usando análise de frequência de letras.', category: 'crypto', difficulty: 'easy', points: 130, flag: 'PAJI{substitution}', hint: 'Letra mais comum é E', solution_explanation: null, order_index: 24, is_active: true, file_url: 'https://files.ctf.blynk.app/substitution.txt' },
  { id: 's25', title: 'Diffie-Hellman Weak', description: 'Explore parâmetros fracos no protocolo Diffie-Hellman para calcular a chave secreta.', category: 'crypto', difficulty: 'hard', points: 480, flag: 'PAJI{dh_weak}', hint: 'Grupo primo é pequeno, calcule log discreto', solution_explanation: null, order_index: 25, is_active: true, file_url: 'https://files.ctf.blynk.app/dh_params.json' },
  { id: 's26', title: 'ECDSA Nonce Reuse', description: 'Recupere chave privada ECDSA de duas assinaturas que usaram o mesmo nonce k.', category: 'crypto', difficulty: 'insane', points: 950, flag: 'PAJI{ecdsa_nonce}', hint: 'k = (z1 - z2) / (s1 - s2) mod n', solution_explanation: null, order_index: 26, is_active: true, file_url: 'https://files.ctf.blynk.app/ecdsa_signatures.json' },
