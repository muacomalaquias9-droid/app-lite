      ...
      <div className="sticky top-0 z-40 bg-background/80 backdrop-blur border-b border-border">
        <div className="flex items-center gap-3 px-4 h-14 max-w-3xl mx-auto">
          ...
          <div className="flex-1">
            <h1 className="text-lg font-bold flex items-center gap-2"><KeyRound className="h-4 w-4" /> Paji API</h1>
          ...
          <div className="flex items-start gap-3">
            ...
            <div className="flex-1">
              ...
              <p className="text-sm text-muted-foreground">
                Esta API dá acesso completo aos dados do Paji (posts, perfis, mensagens, login). Mantém a chave secreta privada — nunca a publiques no front-end.
              </p>
            </div>
          </div>
        </Card>
